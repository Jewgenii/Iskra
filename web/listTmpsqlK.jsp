    ...
    <body>
            ...
            <div class="panel panel-default">
                ...
                <div id="collapse1" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <div class="container-fluid">
                            <form  class="search" method="get" name="frm" action="SearchTmpK">
                                ...
                                <label>Позначення</label> <input type="text" minlength="3" size="12px" name="osdk" value="${osdk}" id="osdk" align="middle" placeholder="ОСД-Куди">
        ...
        <div class="container-fluid">
            <nav class="pag" role='pagination'>
                <ul class="pagination">
                    <c:choose>
                        <c:when test="${page == 1}"><li><a class="disabled" href="TmpsqlKController?action=list&page=1">Перша</a></li></c:when> 
                        <c:otherwise><li><a class="a2" href="TmpsqlKController?action=list&page=1">Перша</a></li></c:otherwise>
                        </c:choose>

                    <c:choose>
                        <c:when test="${page <=1}"><li class="li1"><a class="disabled" href="TmpsqlKController?action=list&page=${page-1}"><span class="glyphicon glyphicon-chevron-left"></span></a></li></c:when> 
                        <c:otherwise><li class="li1"><a class="a2" href="TmpsqlKController?action=list&page=${page-1}"><span class="glyphicon glyphicon-chevron-left"></span></a></li></c:otherwise> 
                        </c:choose>
                    ...
                    <c:forEach var="i" begin="${ firstPageNum > 0 ? firstPageNum : 1 }" 
                        ...
                        <c:choose>
                            <c:when test="${i == page}"><li class="li1"><a class="a2" style="color: #2e6da4;" href="TmpsqlKController?action=list&page=${i}"><b>${i}</b></a></li></c:when>
                            <c:otherwise><li class="li1"><a class="a2" href="TmpsqlKController?action=list&page=${i}">${i}</a></li></c:otherwise>
                            </c:choose>   
                        </c:forEach>

                    <c:choose>
                        <c:when test="${page >= counts}"><li class="li1"><a class="disabled" href="TmpsqlKController?action=list&page=${page+1}"><span class="glyphicon glyphicon-chevron-right"></span></a></li></c:when> 
                        <c:otherwise><li><a class="a2" href="TmpsqlKController?action=list&page=${page+1}"><span class="glyphicon glyphicon-chevron-right"></span></a></li></c:otherwise>
                        </c:choose>
