 ...
 * @author u27brvz18
 */
public class TmpsqlChController extends HttpServlet {

    private static String INSERT_OR_EDIT = "/";
    private static String LIST_TMPSQLCH = "/listTmpsqlCh.jsp";
    private TmpsqlChDao dao;

    public TmpsqlChController() {
        super();
        dao = new TmpsqlChDao();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equalsIgnoreCase("list")) {
            ...
            forward = LIST_TMPSQLCH;
            request.setAttribute("tmpsqlChs", dao.getAllTmpsqlCh(Integer.parseInt(page)));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher view = request.getRequestDispatcher(LIST_TMPSQLCH);
        request.setAttribute("tmpsqlChs", dao.getAllTmpsqlCh(1));
